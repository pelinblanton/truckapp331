...
fun CurrentDeliveryDetails(
    ...
    Scaffold(
        ...
        Column(
            ...
            // Header Card: name, time, quantity
            Card(
            ...
            Card(
                ...
                Column(
                    ...
                    Row(
                        ...
                        AssistChip(
                            onClick = { /* future: capture signature / confirmation */ },
                            label = {
                        ...
                        AssistChip(
                            onClick = { /* future: capture driver confirm */ },
                            label = {
            ...
            // Report issue button
            OutlinedButton(
                onClick = { /* Hook up to reporting screen or log later */ },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(48.dp),
